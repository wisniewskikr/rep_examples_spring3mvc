...
<div style="width: 400px; font-family: Arial; font-size: 9pt;">
	<table>
		...
		<tr>
			<td colspan="2">
				<input type="button" id="update" name="update" value="Update" onclick="send('edit/update-button');"/>
				<input type="button" id="cancel" name="cancel" value="Cancel" onclick="send('edit/cancel-button');"/>
			</td>
		</tr>		
	</table>
</div>
